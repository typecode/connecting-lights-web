...
onKeyUp="limitText(this.form.m,this.form.countdown,100);"></textarea><br>
				
You have <input readonly type="text" name="countdown" class="countdownclass" value="100"> characters left.</font>				
			...
			<form method="post" action="question.php"><?php
				...
				<input type="submit" value="Another question"></input>			
			</form>
		</div>
